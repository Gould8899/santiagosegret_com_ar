...
window.SiteTranslations = {
  ...
  ja: {
    ...
    'videos.busquedas.3': '「Libro de Bucles」の断片。',
    'videos.busquedas.4': '「Libro de Bucles」。',
    'videos.busquedas.5': '自家製の音楽作品。',
    'videos.busquedas.6': 'UNA の作曲学位のために制作されたピアノソナタ。',
    'videos.busquedas.7': 'バンドネオン入り弦楽四重奏。',
    'videos.busquedas.8': '私のピアノのための曲。',
    'videos.busquedas.9': 'Thelonious Monk の研究。',
    'videos.busquedas.10': 'ショパンの前奏曲第16番。',
    'videos.busquedas.11': 'ショパンの練習曲第1番。',
    'videos.busquedas.12': 'ショパンの前奏曲第3番。',
    'videos.busquedas.13': 'ピアノ演奏。',
    'videos.busquedas.14': 'パナマにて録音。',
    'videos.busquedas.15': 'ピアノによるマエストロ・バッハの4つのデュエットの一つ。',
